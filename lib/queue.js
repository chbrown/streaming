...
*/
var Queue = module.exports = function(concurrency, transform, options) {
  stream.Duplex.call(this, options);
  this.concurrency = concurrency;
  this.transform = transform;
  this._in_progress = 0;
};
util.inherits(Queue, stream.Duplex);
...
Queue.prototype._write = function(chunk, encoding, callback) {
  ...
  var self = this;
  this.transform(chunk, encoding, function(err, outputChunk) {
    self._in_progress--;
