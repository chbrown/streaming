...
var ArrayStringifier = exports.ArrayStringifier = function(replacer, space) {
  /** streaming.json.ArrayStringifier collects all written objects into a
  single array and dumps that array when it is ended.
...
util.inherits(ArrayStringifier, stream.Transform);
...
ArrayStringifier.prototype._flush = function(callback) {
  this.push(JSON.stringify(this._buffer, this.replacer, this.space));
  callback();
};
